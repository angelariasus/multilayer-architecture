DROP TABLE IF EXISTS multas CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS prestamos CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS reservas CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS ejemplares CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS libros CASCADE CONSTRAINTS;
